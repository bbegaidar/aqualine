                            ...
                            <div class="sliderport">
                                ...
                                <div class="img32">
                                    <div class="hawaya">
                                        ...
                                        <p class="ppakva"><?=Yii::t('app', 'Площадь')?>: <br> <b><?=$portfolio->area?> кв.м.</b><br><br>
                                        <?=Yii::t('app', 'Локация')?>: <br> <b><?=$portfolio->location?></b>
                                        </p>
    ...
    <?php if ($portfolios != null): ?>
        ...
        <?php foreach ($filtered as $portfolio): ?>
            <div class="kart">
                ...
                <hr class="kart__hr">
                <p class="kartp2"> <?=Yii::t('app', 'Площадь')?>: <br> <b><?=$portfolio->area?> кв.м.</b> <br><br><br>
                <?=Yii::t('app', 'Локация')?>:<br> <b><?=$portfolio->location?></b> <br><br></p>
                <?php
                    if (!empty($portfolio->images)) {$images = json_decode($portfolio->images);}
                ?>
                <?php if ($images != null && isset($images[0])): ?>
